...
class QuizViewModel: ObservableObject {
    ...
    func fetchQuestions(completion: @escaping () -> Void) {
        ...
        db.collection("Quiz").document("EnglishQuiz").getDocument { (snapshot, error) in // searching for the document
            if let error = error {
...
struct EnglishQuizView: View {
    ...
    @State private var quizId = "English Quiz"
    ...
    @State private var showKeyboardSettingsAlert = false
                    ...
                    if quizCompleted {
                        ...
                        VStack {
                            ...
                            TextField("Enter your answer", text: $answer, onCommit: submitAnswer)
                                ...
                                .onReceive(Just(currentQuestionIndex)) { _ in
                                    self.isKeyboardVisible = true
                                }
...
struct EnglishQuizView_Previews: PreviewProvider {
